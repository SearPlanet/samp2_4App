...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        actiontools = new QAction(QWMainWind);
        actiontools->setObjectName("actiontools");
        actiontools->setCheckable(true);
        actionhelp = new QAction(QWMainWind);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actiontools->setText(QCoreApplication::translate("QWMainWind", "about", nullptr));
        actionhelp->setText(QCoreApplication::translate("QWMainWind", "help", nullptr));
